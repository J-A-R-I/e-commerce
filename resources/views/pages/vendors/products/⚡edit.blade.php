...
<section class="max-w-2xl mx-auto space-y-6">
    <div class="space-y-2">
        ...
        <flux:heading size="xl" level="1">{{ __('Product bewerken') }}</flux:heading>
        <flux:subheading>{{ __('Pas de gegevens van het product aan.') }}</flux:subheading>
    </div>

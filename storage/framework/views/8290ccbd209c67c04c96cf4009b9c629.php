...
<?php # [BlazeFolded]:{flux::radio}:{C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/radio/index.blade.php}:{1789445708} ?>
<?php # [BlazeFolded]:{flux::radio}:{C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/radio/index.blade.php}:{1789445708} ?>
<?php # [BlazeFolded]:{flux::radio}:{C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/radio/index.blade.php}:{1789445708} ?>
<?php # [BlazeFolded]:{flux::radio.group}:{C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/radio/group/index.blade.php}:{1789445708} ?>
<?php
...
<section class="w-full">
    ...
    <?php ob_start(); ?><h2 class="font-medium [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white text-sm [&amp;:has(+[data-flux-subheading])]:mb-2 [[data-flux-subheading]+&amp;]:mt-2 sr-only" data-flux-heading><?php ob_start(); ?><?php echo e(__('Appearance settings')); ?><?php echo trim(ob_get_clean()); ?></h2>
...
<?php /**PATH C:\wamp64\www\ecommerce\resources\views\pages\settings\⚡appearance.blade.php ENDPATH**/ ?>
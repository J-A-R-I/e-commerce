<?php
if (!function_exists('__75e071ffd373209de47488914028dead')):
function __75e071ffd373209de47488914028dead($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php if ($collapsibleOnMobile): ?>
    <?php if (!function_exists('__65813d2affb7dc2005c9116f0ff36a97')) { $__blaze->compile('C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/sidebar/backdrop.blade.php', $__blaze->compiledPath.'/65813d2affb7dc2005c9116f0ff36a97.php'); require $__blaze->compiledPath.'/65813d2affb7dc2005c9116f0ff36a97.php'; } ?>
<?php $__blaze->pushData([]); ?>
<?php __65813d2affb7dc2005c9116f0ff36a97($__blaze, [], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
<?php endif; ?>
...
} endif; ?><?php /**PATH C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/sidebar/index.blade.php ENDPATH**/ ?>
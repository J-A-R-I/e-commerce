<?php
if (!function_exists('__97aa16afebcd7cbf430583a42f6d448e')):
function __97aa16afebcd7cbf430583a42f6d448e($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<ui-sidebar-toggle <?php echo e($attributes->class($classes)); ?> data-flux-sidebar-collapse>
    <?php if (!function_exists('__6d25880f36f3c7fd95605087d23b27de')) { $__blaze->compile('C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/tooltip/index.blade.php', $__blaze->compiledPath.'/6d25880f36f3c7fd95605087d23b27de.php'); require $__blaze->compiledPath.'/6d25880f36f3c7fd95605087d23b27de.php'; } ?>
...
<?php $__attrs6d25880f36f3c7fd95605087d23b27de = ['content' => $tooltip,'position' => $tooltipPosition,'kbd' => $tooltipKbd]; ?>
...
<?php ob_start(); ?>
    ...
    <?php $__slots6d25880f36f3c7fd95605087d23b27de['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slots6d25880f36f3c7fd95605087d23b27de); ?>
<?php __6d25880f36f3c7fd95605087d23b27de($__blaze, $__attrs6d25880f36f3c7fd95605087d23b27de, $__slots6d25880f36f3c7fd95605087d23b27de, ['content', 'position', 'kbd'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
} endif; ?><?php /**PATH C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/sidebar/collapse.blade.php ENDPATH**/ ?>
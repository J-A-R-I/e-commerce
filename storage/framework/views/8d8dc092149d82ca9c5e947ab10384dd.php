...
new #[Layout('layouts.store')] class extends Component {
    ...
    public function save(): void
    {
        ...
        Category::create(array_merge($validated, ['store_id' => $this->store->id]));

        Flux::toast(variant: 'success', text: __('Categorie aangemaakt.'));
...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <?php ob_start(); ?><h1 class="font-medium [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white text-2xl [&amp;:has(+[data-flux-subheading])]:mb-2 [[data-flux-subheading]+&amp;]:mt-2" data-flux-heading><?php ob_start(); ?><?php echo e(__('Nieuwe Categorie')); ?><?php echo trim(ob_get_clean()); ?></h1>

        <?php echo ltrim(ob_get_clean()); ?>
        <?php ob_start(); ?><div class="text-sm [:where(&amp;)]:text-zinc-500 [:where(&amp;)]:dark:text-white/70" data-flux-subheading>
    <?php ob_start(); ?><?php echo e(__('Maak een nieuwe categorie aan.')); ?><?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
            ...
            <span><?php ob_start(); ?>
                    <?php echo e(__('Categorie aanmaken')); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
</section><?php /**PATH C:\wamp64\www\ecommerce\resources\views\pages\vendors\categories\⚡create.blade.php ENDPATH**/ ?>
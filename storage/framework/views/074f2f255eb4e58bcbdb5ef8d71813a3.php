...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <div class="flex items-center justify-between gap-4">
            <?php ob_start(); ?><h1 class="font-medium [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white text-2xl [&amp;:has(+[data-flux-subheading])]:mb-2 [[data-flux-subheading]+&amp;]:mt-2" data-flux-heading><?php ob_start(); ?><?php echo e($user->firstname); ?> <?php echo e($user->lastname); ?><?php echo trim(ob_get_clean()); ?></h1>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <?php ob_start(); ?>
        <div class="flex justify-between items-center py-1.5">
            <span class="text-zinc-500 dark:text-zinc-400"><?php echo e(__('Voornaam')); ?></span>
            <span class="font-medium text-zinc-900 dark:text-white"><?php echo e($user->firstname); ?></span>
        </div>

        <div class="flex justify-between items-center py-1.5">
            <span class="text-zinc-500 dark:text-zinc-400"><?php echo e(__('Achternaam')); ?></span>
            <span class="font-medium text-zinc-900 dark:text-white"><?php echo e($user->lastname); ?></span>
        </div>

        <div class="flex justify-between items-center py-1.5">
            <span class="text-zinc-500 dark:text-zinc-400"><?php echo e(__('E-mailadres')); ?></span>
            <span class="font-medium text-zinc-900 dark:text-white"><?php echo e($user->email); ?></span>
        </div>

        <div class="flex justify-between items-center py-1.5">
            <span class="text-zinc-500 dark:text-zinc-400"><?php echo e(__('Rol')); ?></span>
        ...
        <?php ob_start(); ?><?php echo e(ucfirst($user->role?->name ?? '-')); ?><?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <div class="flex justify-between items-center py-1.5">
            ...
            <span class="text-zinc-700 dark:text-zinc-300"><?php echo e($user->created_at?->format('d-m-Y H:i')); ?></span>
        </div>
...
<?php /**PATH C:\wamp64\www\ecommerce\resources\views\pages\admin\users\⚡show.blade.php ENDPATH**/ ?>
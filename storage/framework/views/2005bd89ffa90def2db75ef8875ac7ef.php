<?php
if (!function_exists('_2005bd89ffa90def2db75ef8875ac7ef')):
function _2005bd89ffa90def2db75ef8875ac7ef($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH C:\wamp64\www\ecommerce\vendor\livewire\flux\stubs\resources\views\flux\icon\archive-box-arrow-down.blade.php ENDPATH**/ ?>
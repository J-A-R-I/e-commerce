<?php
if (!function_exists('_d806f3c89668ef2181b6a660cfd5449b')):
function _d806f3c89668ef2181b6a660cfd5449b($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php $__attrs07770e4b33b38e95ba5e57ae973043a8 = ['attributes' => $attributes->class($classes),'dataFluxNavbarItems' => true]; ?>
...
<?php _67cfd735fe19824f967450cd492c334e($__blaze, ['icon' => $iconTrailing,'variant' => $iconVariant,'class' => $iconClasses], [], ['icon', 'variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
            <?php else: ?>
...
<?php _67cfd735fe19824f967450cd492c334e($__blaze, ['icon' => $iconTrailing,'variant' => $iconVariant,'class' => $iconClasses.' ms-1'], [], ['icon', 'variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
    ...
    <?php if (isset($badge) && $badge !== ''): ?>
        ...
        <?php if (!function_exists('_1b48e9050d801370991942d12725e813')) { $__blaze->compile('C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/navbar/badge.blade.php', $__blaze->compiledPath.'/1b48e9050d801370991942d12725e813.php'); require $__blaze->compiledPath.'/1b48e9050d801370991942d12725e813.php'; } ?>
<?php if (isset($__slots1b48e9050d801370991942d12725e813)) { $__slotsStack1b48e9050d801370991942d12725e813[] = $__slots1b48e9050d801370991942d12725e813; } ?>
<?php if (isset($__attrs1b48e9050d801370991942d12725e813)) { $__attrsStack1b48e9050d801370991942d12725e813[] = $__attrs1b48e9050d801370991942d12725e813; } ?>
<?php $__attrs1b48e9050d801370991942d12725e813 = ['attributes' => $badgeAttributes]; ?>
<?php $__slots1b48e9050d801370991942d12725e813 = []; ?>
<?php $__blaze->pushData($__attrs1b48e9050d801370991942d12725e813); ?>
<?php ob_start(); ?><?php echo e($badge); ?><?php $__slots1b48e9050d801370991942d12725e813['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slots1b48e9050d801370991942d12725e813); ?>
<?php _1b48e9050d801370991942d12725e813($__blaze, $__attrs1b48e9050d801370991942d12725e813, $__slots1b48e9050d801370991942d12725e813, ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStack1b48e9050d801370991942d12725e813)) { $__slots1b48e9050d801370991942d12725e813 = array_pop($__slotsStack1b48e9050d801370991942d12725e813); } ?>
<?php if (! empty($__attrsStack1b48e9050d801370991942d12725e813)) { $__attrs1b48e9050d801370991942d12725e813 = array_pop($__attrsStack1b48e9050d801370991942d12725e813); } ?>
<?php $__blaze->popData(); ?>
    <?php endif; ?>
...
<?php _07770e4b33b38e95ba5e57ae973043a8($__blaze, $__attrs07770e4b33b38e95ba5e57ae973043a8, $__slots07770e4b33b38e95ba5e57ae973043a8, ['attributes', 'dataFluxNavbarItems'], ['dataFluxNavbarItems' => 'data-flux-navbar-items'], $__this ?? (isset($this) ? $this : null)); ?>
...
} endif; ?><?php /**PATH C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/navbar/item.blade.php ENDPATH**/ ?>
<?php
if (!function_exists('_dfa58f5ccec4386bccd1f06cb8cd035d')):
function _dfa58f5ccec4386bccd1f06cb8cd035d($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH C:\wamp64\www\ecommerce\vendor\livewire\flux\stubs\resources\views\flux\icon\arrow-turn-right-down.blade.php ENDPATH**/ ?>
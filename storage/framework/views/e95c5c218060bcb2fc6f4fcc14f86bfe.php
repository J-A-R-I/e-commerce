<?php
if (!function_exists('_e95c5c218060bcb2fc6f4fcc14f86bfe')):
function _e95c5c218060bcb2fc6f4fcc14f86bfe($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php if (!function_exists('_caac821c4db56d477f8ef256e270b997')) { $__blaze->compile('C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/accent.blade.php', $__blaze->compiledPath.'/caac821c4db56d477f8ef256e270b997.php'); require $__blaze->compiledPath.'/caac821c4db56d477f8ef256e270b997.php'; } ?>
<?php if (isset($__slotscaac821c4db56d477f8ef256e270b997)) { $__slotsStackcaac821c4db56d477f8ef256e270b997[] = $__slotscaac821c4db56d477f8ef256e270b997; } ?>
<?php if (isset($__attrscaac821c4db56d477f8ef256e270b997)) { $__attrsStackcaac821c4db56d477f8ef256e270b997[] = $__attrscaac821c4db56d477f8ef256e270b997; } ?>
<?php $__attrscaac821c4db56d477f8ef256e270b997 = ['color' => $color,'class' => 'contents']; ?>
<?php $__slotscaac821c4db56d477f8ef256e270b997 = []; ?>
<?php $__blaze->pushData($__attrscaac821c4db56d477f8ef256e270b997); ?>
<?php ob_start(); ?>
...
<?php _67cfd735fe19824f967450cd492c334e($__blaze, ['icon' => 'loading','variant' => 'micro','class' => $square && $size !== 'xs' ? 'size-5' : 'size-4'], [], ['class'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php _67cfd735fe19824f967450cd492c334e($__blaze, ['icon' => $onIcon ?? $icon,'variant' => 'solid','class' => $iconClasses->add('hidden group-data-checked:block')], [], ['icon', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
...
<?php _67cfd735fe19824f967450cd492c334e($__blaze, ['icon' => $offIcon ?? $onIcon ?? $icon,'variant' => 'outline','class' => $iconClasses->add('group-data-checked:hidden')], [], ['icon', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
            <?php elseif ($icon): ?>
                <?php echo e($icon); ?>
...
<?php $__blaze->popData(); ?>
<?php $__slotscaac821c4db56d477f8ef256e270b997['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slotscaac821c4db56d477f8ef256e270b997); ?>
<?php _caac821c4db56d477f8ef256e270b997($__blaze, $__attrscaac821c4db56d477f8ef256e270b997, $__slotscaac821c4db56d477f8ef256e270b997, ['color'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStackcaac821c4db56d477f8ef256e270b997)) { $__slotscaac821c4db56d477f8ef256e270b997 = array_pop($__slotsStackcaac821c4db56d477f8ef256e270b997); } ?>
<?php if (! empty($__attrsStackcaac821c4db56d477f8ef256e270b997)) { $__attrscaac821c4db56d477f8ef256e270b997 = array_pop($__attrsStackcaac821c4db56d477f8ef256e270b997); } ?>
<?php $__blaze->popData(); ?>
<?php
echo ltrim(ob_get_clean());
} endif; ?><?php /**PATH C:\wamp64\www\ecommerce\vendor\livewire\flux\stubs\resources\views\flux\toggle.blade.php ENDPATH**/ ?>
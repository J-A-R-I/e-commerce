...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <?php ob_start(); ?><h1 class="font-medium [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white text-2xl [&amp;:has(+[data-flux-subheading])]:mb-2 [[data-flux-subheading]+&amp;]:mt-2" data-flux-heading><?php ob_start(); ?><?php echo e(__('Nieuw Product')); ?><?php echo trim(ob_get_clean()); ?></h1>

        <?php echo ltrim(ob_get_clean()); ?>
        <?php ob_start(); ?><div class="text-sm [:where(&amp;)]:text-zinc-500 [:where(&amp;)]:dark:text-white/70" data-flux-subheading>
    <?php ob_start(); ?><?php echo e(__('Maak een nieuw product aan voor :store.', ['store' => $store->name])); ?>
...
<?php $__blaze->popData(); ?>
                    ...
                    <?php if (!function_exists('_205395226ef5a10927c9e81d13a34aec')) { $__blaze->compile('C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/input/index.blade.php', $__blaze->compiledPath.'/205395226ef5a10927c9e81d13a34aec.php'); require $__blaze->compiledPath.'/205395226ef5a10927c9e81d13a34aec.php'; } ?>
<?php $__blaze->pushData(['wire:model' => 'price','type' => 'number','step' => '0.01','min' => '0','label' => __('Prijs (€)'),'placeholder' => e(__('29.99')),'required' => true]); ?>
<?php _205395226ef5a10927c9e81d13a34aec($__blaze, ['wire:model' => 'price','type' => 'number','step' => '0.01','min' => '0','label' => __('Prijs (€)'),'placeholder' => e(__('29.99')),'required' => true], [], ['label', 'required'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
            ...
            <span><?php ob_start(); ?>
                    <?php echo e(__('Product aanmaken')); ?>
...
<?php /**PATH C:\wamp64\www\ecommerce\resources\views\pages\vendors\products\⚡create.blade.php ENDPATH**/ ?>
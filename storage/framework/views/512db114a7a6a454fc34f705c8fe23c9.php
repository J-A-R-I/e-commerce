...
<?php echo ltrim(ob_get_clean()); ?>
        <div class="flex items-center justify-between gap-4">
            <?php ob_start(); ?><h1 class="font-medium [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white text-2xl [&amp;:has(+[data-flux-subheading])]:mb-2 [[data-flux-subheading]+&amp;]:mt-2" data-flux-heading><?php ob_start(); ?><?php echo e($product->name); ?><?php echo trim(ob_get_clean()); ?></h1>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <?php ob_start(); ?><div class="border [:where(&amp;)]:bg-white [:where(&amp;)]:border-zinc-200 dark:[:where(&amp;)]:bg-white/10 dark:[:where(&amp;)]:border-white/10 [:where(&amp;)]:p-6 [:where(&amp;)]:rounded-xl [--flux-bleed:1.5rem] space-y-4 text-sm" data-flux-card>
    <?php ob_start(); ?>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-1">
            <div class="space-y-1">
                <div class="flex justify-between items-center py-1.5 border-b border-zinc-100 dark:border-zinc-800">
                    ...
                    <span class="font-medium text-zinc-900 dark:text-white"><?php echo e($product->name); ?></span>
                </div>
                <div class="flex justify-between items-center py-1.5 border-b border-zinc-100 dark:border-zinc-800">
                    <span class="text-zinc-500 dark:text-zinc-400"><?php echo e(__('Prijs')); ?></span>
                    <span class="font-medium text-zinc-900 dark:text-white">€
                        <?php echo e(number_format((float) ($product->price ?? 0), 2, ',', '.')); ?></span>
                </div>
                <div class="flex justify-between items-center py-1.5 border-b border-zinc-100 dark:border-zinc-800">
                    <span class="text-zinc-500 dark:text-zinc-400"><?php echo e(__('Categorie')); ?></span>
                    <span
                        class="font-medium text-zinc-900 dark:text-white"><?php echo e($product->category?->name ?? '-'); ?></span>
                </div>
            ...
            <div class="space-y-1">
                <div class="flex justify-between items-center py-1.5 border-b border-zinc-100 dark:border-zinc-800">
                    <span class="text-zinc-500 dark:text-zinc-400"><?php echo e(__('Voorraad')); ?></span>
                    <span class="font-medium text-zinc-900 dark:text-white"><?php echo e($product->stock); ?></span>
                </div>
                <div class="flex justify-between items-center py-1.5 border-b border-zinc-100 dark:border-zinc-800">
                    <span class="text-zinc-500 dark:text-zinc-400"><?php echo e(__('SKU')); ?></span>
                    <span class="font-medium text-zinc-900 dark:text-white"><?php echo e($product->sku ?? '-'); ?></span>
                </div>
                <div class="flex justify-between items-center py-1.5 border-b border-zinc-100 dark:border-zinc-800">
...
<?php ob_start(); ?>
                        <?php echo e($product->is_active ? 'actief' : 'inactief'); ?>
...
<?php $__blaze->popData(); ?>
                ...
                <div class="flex justify-between items-center py-1.5 border-b border-zinc-100 dark:border-zinc-800">
                    ...
                    <span
                        class="text-zinc-700 dark:text-zinc-300"><?php echo e($product->created_at?->format('d-m-Y H:i')); ?></span>
                </div>
                <div class="flex justify-between items-center py-1.5">
                    <span class="text-zinc-500 dark:text-zinc-400"><?php echo e(__('Ge�pdatet op')); ?></span>
                    <span
                        class="text-zinc-700 dark:text-zinc-300"><?php echo e($product->updated_at?->format('d-m-Y H:i')); ?></span>
                </div>
            </div>
        </div>
...
<?php echo ltrim(ob_get_clean()); ?>
</section><?php /**PATH C:\wamp64\www\ecommerce\resources\views\pages\vendors\products\⚡show.blade.php ENDPATH**/ ?>
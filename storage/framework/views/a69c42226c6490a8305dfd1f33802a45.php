...
<?php # [BlazeFolded]:{flux::menu.radio.group}:{C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/menu/radio/group.blade.php}:{1789445708} ?>
<?php # [BlazeFolded]:{flux::menu.separator}:{C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/menu/separator.blade.php}:{1789445708} ?>
<?php # [BlazeFolded]:{flux::menu.item}:{C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/menu/item.blade.php}:{1789445708} ?>
<?php # [BlazeFolded]:{flux::menu.radio.group}:{C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/menu/radio/group.blade.php}:{1789445708} ?>
<?php # [BlazeFolded]:{flux::menu.separator}:{C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/menu/separator.blade.php}:{1789445708} ?>
<?php # [BlazeFolded]:{flux::menu.item}:{C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/menu/item.blade.php}:{1789445708} ?>
...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <?php
        $currentStore = request()->route('store') ?? auth()->user()?->store;
    ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.app-logo','data' => ['sidebar' => true,'href' => ''.e(route('dashboard', $currentStore)).'','wire:navigate' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['sidebar' => true,'href' => ''.e(route('dashboard', $currentStore)).'','wire:navigate' => true]); ?>
...
<?php $__attrsbc7e1d423a3a26f95880ca0839836fdf = ['heading' => __('Platform'),'class' => 'grid']; ?>
...
<?php $__attrs1dd8ad8b7dba522afd1fb67ddac51e66 = ['icon' => 'home','href' => route('dashboard', $currentStore),'current' => request()->routeIs('dashboard'),'wire:navigate' => true]; ?>
...
<?php if (isset($__slots1dd8ad8b7dba522afd1fb67ddac51e66)) { $__slotsStack1dd8ad8b7dba522afd1fb67ddac51e66[] = $__slots1dd8ad8b7dba522afd1fb67ddac51e66; } ?>
<?php if (isset($__attrs1dd8ad8b7dba522afd1fb67ddac51e66)) { $__attrsStack1dd8ad8b7dba522afd1fb67ddac51e66[] = $__attrs1dd8ad8b7dba522afd1fb67ddac51e66; } ?>
<?php $__attrs1dd8ad8b7dba522afd1fb67ddac51e66 = ['icon' => 'home','href' => route('products', $currentStore),'current' => request()->routeIs('products'),'wire:navigate' => true]; ?>
<?php $__slots1dd8ad8b7dba522afd1fb67ddac51e66 = []; ?>
<?php $__blaze->pushData($__attrs1dd8ad8b7dba522afd1fb67ddac51e66); ?>
<?php ob_start(); ?>
...
<?php if (isset($__slots1dd8ad8b7dba522afd1fb67ddac51e66)) { $__slotsStack1dd8ad8b7dba522afd1fb67ddac51e66[] = $__slots1dd8ad8b7dba522afd1fb67ddac51e66; } ?>
<?php if (isset($__attrs1dd8ad8b7dba522afd1fb67ddac51e66)) { $__attrsStack1dd8ad8b7dba522afd1fb67ddac51e66[] = $__attrs1dd8ad8b7dba522afd1fb67ddac51e66; } ?>
<?php $__attrs1dd8ad8b7dba522afd1fb67ddac51e66 = ['icon' => 'home','href' => route('categories', $currentStore),'current' => request()->routeIs('categories'),'wire:navigate' => true]; ?>
<?php $__slots1dd8ad8b7dba522afd1fb67ddac51e66 = []; ?>
<?php $__blaze->pushData($__attrs1dd8ad8b7dba522afd1fb67ddac51e66); ?>
<?php ob_start(); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <?php ob_start(); ?>
            <?php if (!function_exists('_5fb7f42c5b3cb3e987bfdd8941549a3c')) { $__blaze->compile('C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/profile.blade.php', $__blaze->compiledPath.'/5fb7f42c5b3cb3e987bfdd8941549a3c.php'); require $__blaze->compiledPath.'/5fb7f42c5b3cb3e987bfdd8941549a3c.php'; } ?>
<?php $__blaze->pushData(['initials' => auth()->user()->initials(),'iconTrailing' => 'chevron-down']); ?>
<?php _5fb7f42c5b3cb3e987bfdd8941549a3c($__blaze, ['initials' => auth()->user()->initials(),'iconTrailing' => 'chevron-down'], [], ['initials'], ['iconTrailing' => 'icon-trailing'], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
    ...
    <?php ob_start(); ?>
                    <div class="p-0 text-sm font-normal">
                        <div class="flex items-center gap-2 px-1 py-1.5 text-start text-sm">
                            <?php $blaze_memoized_key = \Livewire\Blaze\Memoizer\Memo::key("flux::avatar", ['name' => auth()->user()->name, 'initials' => auth()->user()->initials()]); ?><?php if ($blaze_memoized_key !== null && \Livewire\Blaze\Memoizer\Memo::has($blaze_memoized_key)) : ?><?php echo \Livewire\Blaze\Memoizer\Memo::get($blaze_memoized_key); ?><?php else : ?><?php ob_start(); ?><?php if (!function_exists('_bffe6c48ea7d30a306a4ff2e8052e2f6')) { $__blaze->compile('C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/avatar/index.blade.php', $__blaze->compiledPath.'/bffe6c48ea7d30a306a4ff2e8052e2f6.php'); require $__blaze->compiledPath.'/bffe6c48ea7d30a306a4ff2e8052e2f6.php'; } ?>
<?php $__blaze->pushData(['name' => auth()->user()->name,'initials' => auth()->user()->initials()]); ?>
<?php _bffe6c48ea7d30a306a4ff2e8052e2f6($__blaze, ['name' => auth()->user()->name,'initials' => auth()->user()->initials()], [], ['name', 'initials'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php /**PATH C:\wamp64\www\ecommerce\resources\views\layouts\store\sidebar.blade.php ENDPATH**/ ?>
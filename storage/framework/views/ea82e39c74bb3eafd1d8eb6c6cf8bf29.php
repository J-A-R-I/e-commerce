...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <div class="flex items-center justify-between gap-4">
            <?php ob_start(); ?><h1 class="font-medium [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white text-2xl [&amp;:has(+[data-flux-subheading])]:mb-2 [[data-flux-subheading]+&amp;]:mt-2" data-flux-heading><?php ob_start(); ?><?php echo e($role->name); ?><?php echo trim(ob_get_clean()); ?></h1>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <?php ob_start(); ?>
        ...
        <div class="flex justify-between items-center py-1.5">
            <span class="text-zinc-500 dark:text-zinc-400"><?php echo e(__('Beschrijving')); ?></span>
            <span class="font-medium text-zinc-900 dark:text-white"><?php echo e($role->description ?: '-'); ?></span>
        </div>

        <div class="flex justify-between items-center py-1.5">
            <span class="text-zinc-500 dark:text-zinc-400"><?php echo e(__('Aangemaakt op')); ?></span>
            <span class="text-zinc-700 dark:text-zinc-300"><?php echo e($role->created_at?->format('d-m-Y H:i')); ?></span>
        </div>
...
<?php /**PATH C:\wamp64\www\ecommerce\resources\views\pages\admin\roles\⚡show.blade.php ENDPATH**/ ?>
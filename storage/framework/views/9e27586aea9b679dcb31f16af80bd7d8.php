...
<?php _205395226ef5a10927c9e81d13a34aec($__blaze, ['name' => 'name','label' => __('Name'),'value' => old('name'),'type' => 'text','required' => true,'autofocus' => true,'autocomplete' => 'name','placeholder' => __('Full name')], [], ['label', 'value', 'required', 'autofocus', 'placeholder'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php _205395226ef5a10927c9e81d13a34aec($__blaze, ['name' => 'email','label' => __('Email address'),'value' => old('email'),'type' => 'email','required' => true,'autocomplete' => 'email','placeholder' => 'email@example.com'], [], ['label', 'value', 'required'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\ecommerce\resources\views\pages\auth\register.blade.php ENDPATH**/ ?>
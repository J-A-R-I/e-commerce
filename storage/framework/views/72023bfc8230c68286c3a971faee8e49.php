...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <div class="flex items-center justify-between gap-4">
            <?php ob_start(); ?><h1 class="font-medium [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white text-2xl [&amp;:has(+[data-flux-subheading])]:mb-2 [[data-flux-subheading]+&amp;]:mt-2" data-flux-heading><?php ob_start(); ?><?php echo e($store->name); ?><?php echo trim(ob_get_clean()); ?></h1>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <?php ob_start(); ?>
        <div class="flex justify-between items-center py-1.5">
            <span class="text-zinc-500 dark:text-zinc-400"><?php echo e(__('Winkelnaam')); ?></span>
            <span class="font-medium text-zinc-900 dark:text-white"><?php echo e($store->name); ?></span>
        </div>

        <div class="flex justify-between items-center py-1.5">
            <span class="text-zinc-500 dark:text-zinc-400"><?php echo e(__('Eigenaar')); ?></span>
            <span class="font-medium text-zinc-900 dark:text-white"><?php echo e($store->user?->firstname); ?></span>
        </div>

        <div class="flex justify-between items-center py-1.5">
            <span class="text-zinc-500 dark:text-zinc-400"><?php echo e(__('Phone')); ?></span>
            <span class="font-medium text-zinc-900 dark:text-white"><?php echo e($store->phone); ?></span>
        </div>

        <div class="flex justify-between items-center py-1.5">
            <span class="text-zinc-500 dark:text-zinc-400"><?php echo e(__('Slug')); ?></span>
            <span class="font-medium text-zinc-900 dark:text-white"><?php echo e($store->slug); ?></span>
        </div>
        <div class="flex justify-between items-center py-1.5">
            <span class="text-zinc-500 dark:text-zinc-400"><?php echo e(__('Description')); ?></span>
            <span class="font-medium text-zinc-900 dark:text-white"><?php echo e($store->description); ?></span>
        </div>
        <div class="flex justify-between items-center py-1.5">
            <span class="text-zinc-500 dark:text-zinc-400"><?php echo e(__('Logo')); ?></span>
            <span class="font-medium text-zinc-900 dark:text-white"><?php echo e($store->logo ? $store->logo : '-'); ?></span>
        </div>
        <div class="flex justify-between items-center py-1.5">
            <span class="text-zinc-500 dark:text-zinc-400"><?php echo e(__('Banner')); ?></span>
            <span class="font-medium text-zinc-900 dark:text-white"><?php echo e($store->banner ? $store->banner : '-'); ?></span>
        </div>
        <div class="flex justify-between items-center py-1.5">
            <span class="text-zinc-500 dark:text-zinc-400"><?php echo e(__('Active?')); ?></span>
            <span class="font-medium text-zinc-900 dark:text-white"><?php echo e($store->is_active ? 'ja' : 'nee'); ?></span>
        </div>

        <div class="flex justify-between items-center py-1.5">
            <span class="text-zinc-500 dark:text-zinc-400"><?php echo e(__('Aangemaakt op')); ?></span>
            <span class="text-zinc-700 dark:text-zinc-300"><?php echo e($store->created_at?->format('d-m-Y H:i')); ?></span>
        </div>
        <div class="flex justify-between items-center py-1.5">
            <span class="text-zinc-500 dark:text-zinc-400"><?php echo e(__('geupdate op')); ?></span>
            <span class="text-zinc-700 dark:text-zinc-300"><?php echo e($store->updated_at?->format('d-m-Y H:i')); ?></span>
        </div>
...
<?php /**PATH C:\wamp64\www\ecommerce\resources\views\pages\admin\stores\⚡show.blade.php ENDPATH**/ ?>
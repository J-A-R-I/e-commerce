...
<?php $__blaze->popData(); ?>
                ...
                <?php if (!function_exists('_205395226ef5a10927c9e81d13a34aec')) { $__blaze->compile('C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/input/index.blade.php', $__blaze->compiledPath.'/205395226ef5a10927c9e81d13a34aec.php'); require $__blaze->compiledPath.'/205395226ef5a10927c9e81d13a34aec.php'; } ?>
<?php $__blaze->pushData(['wire:model' => 'description','type' => 'text','label' => __('description'),'placeholder' => e(__('description hier'))]); ?>
<?php _205395226ef5a10927c9e81d13a34aec($__blaze, ['wire:model' => 'description','type' => 'text','label' => __('description'),'placeholder' => e(__('description hier'))], [], ['label'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php /**PATH C:\wamp64\www\ecommerce\resources\views\pages\admin\roles\⚡create.blade.php ENDPATH**/ ?>
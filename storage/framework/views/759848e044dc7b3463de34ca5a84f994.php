<?php
if (!function_exists('_759848e044dc7b3463de34ca5a84f994')):
function _759848e044dc7b3463de34ca5a84f994($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php $__attrs07770e4b33b38e95ba5e57ae973043a8 = ['attributes' => $attributes->class($classes),'dataFluxNavlistItem' => true]; ?>
...
<?php _67cfd735fe19824f967450cd492c334e($__blaze, ['icon' => $iconTrailing,'variant' => $iconVariant,'class' => 'size-4!'], [], ['icon', 'variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
            <?php else: ?>
...
<?php $__attrsd611a7fdea5bab6ec7fa1e06cbf14d11 = ['attributes' => $badgeAttributes]; ?>
...
<?php _07770e4b33b38e95ba5e57ae973043a8($__blaze, $__attrs07770e4b33b38e95ba5e57ae973043a8, $__slots07770e4b33b38e95ba5e57ae973043a8, ['attributes', 'dataFluxNavlistItem'], ['dataFluxNavlistItem' => 'data-flux-navlist-item'], $__this ?? (isset($this) ? $this : null)); ?>

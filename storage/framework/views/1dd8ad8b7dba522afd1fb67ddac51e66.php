<?php
if (!function_exists('_1dd8ad8b7dba522afd1fb67ddac51e66')):
function _1dd8ad8b7dba522afd1fb67ddac51e66($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php $__attrs6d25880f36f3c7fd95605087d23b27de = ['position' => $tooltipPosition,'class' => 'block min-w-0']; ?>
...
<?php $__attrs07770e4b33b38e95ba5e57ae973043a8 = ['attributes' => $attributes->class($classes),'dataFluxSidebarItem' => true]; ?>
...
<?php _67cfd735fe19824f967450cd492c334e($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => $iconClasses], [], ['icon', 'variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php _67cfd735fe19824f967450cd492c334e($__blaze, ['icon' => $iconTrailing,'variant' => $iconVariant,'class' => 'in-data-flux-sidebar-collapsed-desktop:not-in-data-flux-sidebar-group-dropdown:hidden size-4!'], [], ['icon', 'variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
        ...
        <?php if (isset($badge) && $badge !== ''): ?>
            ...
            <?php if (!function_exists('_d611a7fdea5bab6ec7fa1e06cbf14d11')) { $__blaze->compile('C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/navlist/badge.blade.php', $__blaze->compiledPath.'/d611a7fdea5bab6ec7fa1e06cbf14d11.php'); require $__blaze->compiledPath.'/d611a7fdea5bab6ec7fa1e06cbf14d11.php'; } ?>
<?php if (isset($__slotsd611a7fdea5bab6ec7fa1e06cbf14d11)) { $__slotsStackd611a7fdea5bab6ec7fa1e06cbf14d11[] = $__slotsd611a7fdea5bab6ec7fa1e06cbf14d11; } ?>
<?php if (isset($__attrsd611a7fdea5bab6ec7fa1e06cbf14d11)) { $__attrsStackd611a7fdea5bab6ec7fa1e06cbf14d11[] = $__attrsd611a7fdea5bab6ec7fa1e06cbf14d11; } ?>
<?php $__attrsd611a7fdea5bab6ec7fa1e06cbf14d11 = ['attributes' => $badgeAttributes,'class' => 'in-data-flux-sidebar-collapsed-desktop:not-in-data-flux-sidebar-group-dropdown:hidden']; ?>
<?php $__slotsd611a7fdea5bab6ec7fa1e06cbf14d11 = []; ?>
<?php $__blaze->pushData($__attrsd611a7fdea5bab6ec7fa1e06cbf14d11); ?>
<?php ob_start(); ?><?php echo e($badge); ?><?php $__slotsd611a7fdea5bab6ec7fa1e06cbf14d11['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slotsd611a7fdea5bab6ec7fa1e06cbf14d11); ?>
<?php _d611a7fdea5bab6ec7fa1e06cbf14d11($__blaze, $__attrsd611a7fdea5bab6ec7fa1e06cbf14d11, $__slotsd611a7fdea5bab6ec7fa1e06cbf14d11, ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStackd611a7fdea5bab6ec7fa1e06cbf14d11)) { $__slotsd611a7fdea5bab6ec7fa1e06cbf14d11 = array_pop($__slotsStackd611a7fdea5bab6ec7fa1e06cbf14d11); } ?>
<?php if (! empty($__attrsStackd611a7fdea5bab6ec7fa1e06cbf14d11)) { $__attrsd611a7fdea5bab6ec7fa1e06cbf14d11 = array_pop($__attrsStackd611a7fdea5bab6ec7fa1e06cbf14d11); } ?>
<?php $__blaze->popData(); ?>
        <?php endif; ?>
...
<?php _07770e4b33b38e95ba5e57ae973043a8($__blaze, $__attrs07770e4b33b38e95ba5e57ae973043a8, $__slots07770e4b33b38e95ba5e57ae973043a8, ['attributes', 'dataFluxSidebarItem'], ['dataFluxSidebarItem' => 'data-flux-sidebar-item'], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php $__blaze->popData(); ?>
    ...
    <?php if (!function_exists('_c4ac87750c455e0eb7c3dc4aeaa97af9')) { $__blaze->compile('C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/tooltip/content.blade.php', $__blaze->compiledPath.'/c4ac87750c455e0eb7c3dc4aeaa97af9.php'); require $__blaze->compiledPath.'/c4ac87750c455e0eb7c3dc4aeaa97af9.php'; } ?>
...
<?php $__attrsc4ac87750c455e0eb7c3dc4aeaa97af9 = ['kbd' => $tooltipKbd,'class' => 'not-in-data-flux-sidebar-collapsed-desktop:hidden in-data-flux-sidebar-group-dropdown:hidden cursor-default']; ?>
<?php $__slotsc4ac87750c455e0eb7c3dc4aeaa97af9 = []; ?>
<?php $__blaze->pushData($__attrsc4ac87750c455e0eb7c3dc4aeaa97af9); ?>
<?php ob_start(); ?>
        <?php echo e($tooltip); ?>

    <?php $__slotsc4ac87750c455e0eb7c3dc4aeaa97af9['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slotsc4ac87750c455e0eb7c3dc4aeaa97af9); ?>
<?php _c4ac87750c455e0eb7c3dc4aeaa97af9($__blaze, $__attrsc4ac87750c455e0eb7c3dc4aeaa97af9, $__slotsc4ac87750c455e0eb7c3dc4aeaa97af9, ['kbd'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php _6d25880f36f3c7fd95605087d23b27de($__blaze, $__attrs6d25880f36f3c7fd95605087d23b27de, $__slots6d25880f36f3c7fd95605087d23b27de, ['position'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
} endif; ?><?php /**PATH C:\wamp64\www\ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/sidebar/item.blade.php ENDPATH**/ ?>
...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <?php ob_start(); ?><h1 class="font-medium [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white text-2xl [&amp;:has(+[data-flux-subheading])]:mb-2 [[data-flux-subheading]+&amp;]:mt-2" data-flux-heading><?php ob_start(); ?><?php echo e(__('Store bewerken')); ?><?php echo trim(ob_get_clean()); ?></h1>

        <?php echo ltrim(ob_get_clean()); ?>
        <?php ob_start(); ?><div class="text-sm [:where(&amp;)]:text-zinc-500 [:where(&amp;)]:dark:text-white/70" data-flux-subheading>
    <?php ob_start(); ?><?php echo e(__('Pas de gegevens van de store aan.')); ?><?php echo trim(ob_get_clean()); ?>
...
<?php /**PATH C:\wamp64\www\ecommerce\resources\views\pages\admin\stores\⚡edit.blade.php ENDPATH**/ ?>
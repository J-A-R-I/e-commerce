<?php
if (!function_exists('_4842c9c5e3072b6739aa1680a18b4ad8')):
function _4842c9c5e3072b6739aa1680a18b4ad8($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _67cfd735fe19824f967450cd492c334e($__blaze, ['variant' => $iconVariant,'icon' => 'check','class' => $iconClasses,'dataFluxMenuItemIcon' => true], [], ['variant', 'class', 'dataFluxMenuItemIcon'], ['dataFluxMenuItemIcon' => 'data-flux-menu-item-icon'], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php _67cfd735fe19824f967450cd492c334e($__blaze, ['icon' => $iconTrailing,'variant' => $iconVariant,'class' => $iconTrailingClasses,'dataFluxMenuItemIcon' => true], [], ['icon', 'variant', 'class', 'dataFluxMenuItemIcon'], ['dataFluxMenuItemIcon' => 'data-flux-menu-item-icon'], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
...
} endif; ?><?php /**PATH C:\wamp64\www\ecommerce\vendor\livewire\flux\stubs\resources\views\flux\menu\checkbox\index.blade.php ENDPATH**/ ?>
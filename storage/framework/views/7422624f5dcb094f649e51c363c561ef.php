...
<body class="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 antialiased flex flex-col">
    <?php ob_start(); ?><?php $__blaze->pushData(['container' => true, 'class' => 'border-b border-zinc-200 bg-white/70 dark:border-zinc-800 dark:bg-zinc-900/70 backdrop-blur-md sticky top-0 z-50']); $__env->pushConsumableComponentData(['container' => true, 'class' => 'border-b border-zinc-200 bg-white/70 dark:border-zinc-800 dark:bg-zinc-900/70 backdrop-blur-md sticky top-0 z-50']); ?><header class="[grid-area:header] z-10 min-h-14  border-b border-zinc-200 bg-white/70 dark:border-zinc-800 dark:bg-zinc-900/70 backdrop-blur-md sticky top-0 z-50" data-flux-header>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.app-logo-icon','data' => ['class' => 'size-8 fill-current text-zinc-900 dark:text-white']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'size-8 fill-current text-zinc-900 dark:text-white']); ?>
...
<?php endif; ?>
            <span class="font-bold text-lg tracking-tight"><?php echo e(config('app.name', 'E-Commerce')); ?></span>
        </div>

        <?php ob_start(); ?><?php $__blaze->pushData(['class' => '-mb-px max-lg:hidden ml-6']); $__env->pushConsumableComponentData(['class' => '-mb-px max-lg:hidden ml-6']); ?><nav class="flex items-center gap-0.5 py-3  -mb-px max-lg:hidden ml-6" data-flux-navbar>
    <?php ob_start(); ?>
...
<?php $__attrsd806f3c89668ef2181b6a660cfd5449b = ['icon' => 'home','href' => route('home'),'current' => request()->routeIs('home'),'wire:navigate' => true]; ?>
...
<?php endif; ?>
            <?php else: ?>
                <?php ob_start(); ?><a href="<?php echo e(route('login')); ?>" data-flux-button="data-flux-button" class="relative items-center font-medium justify-center whitespace-nowrap disabled:opacity-50 dark:disabled:opacity-50 disabled:cursor-default disabled:pointer-events-none disabled:shadow-none justify-center h-8 text-sm rounded-md gap-2 ps-3 pe-3 inline-flex  bg-transparent hover:bg-zinc-800/5 dark:hover:bg-white/15 text-zinc-800 dark:text-white" wire:navigate="">
        <?php ob_start(); ?>
...
<?php $__attrs1dd8ad8b7dba522afd1fb67ddac51e66 = ['icon' => 'home','href' => route('home'),'current' => request()->routeIs('home'),'wire:navigate' => true]; ?>
...
<?php /**PATH C:\wamp64\www\ecommerce\resources\views\layouts\frontend\header.blade.php ENDPATH**/ ?>
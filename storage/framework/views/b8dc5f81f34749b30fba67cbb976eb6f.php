        ...
        <div class="rounded-lg border bg-card text-card-foreground shadow-sm">
            ...
            <div class="flex flex-col space-y-1.5 p-6">
                <div class="flex items-center justify-center mb-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($client->logo_uri ?? null): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($client->client_uri ?? null): ?>
...
<?php /**PATH C:\wamp64\www\ecommerce\vendor\laravel\mcp\resources\views\mcp\authorize.blade.php ENDPATH**/ ?>